...
| **signature** | RSA (clave privada del server) | <mark style="background:#ffcc80;color:#111">HMAC-SHA256 con la pública (PEM Base64) como secreto</mark> |

> **🎯 Objetivo:** `sub → administrator`. **⚙️ Consecuencia:** `alg → HS256` y firmar con la **clave pública del server (PEM en Base64)** como secreto HMAC.
