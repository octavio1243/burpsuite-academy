...
> - **JWT** (el `id_token` de OpenID es un JWT firmado → atacable si la validación es débil) → [[vulnerabilities/018-jwt-attacks/jwt-attacks|teoría JWT]] · [[vulnerabilities/018-jwt-attacks/labs/README|labs JWT]].
