...
- [ ] Burp **Discover content** · `robots.txt` · `sitemap.xml` · `/.git`, `/cgi-bin/phpinfo.php`. → [[vulnerabilities/014-information-disclousure/labs/README|info disclosure · labs]]
- [ ] Comentarios HTML · JS del cliente · backups (`.bak`, `~`, `.old`) · endpoints/API ocultos. → [[vulnerabilities/014-information-disclousure/labs/README|info disclosure · labs]]
