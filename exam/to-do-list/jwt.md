...
> Técnica → carpeta `vulnerabilities/018-jwt-attacks/` · script → [[vulnerabilities/018-jwt-attacks/scripts/crack_jwt.py|crack_jwt.py]]
...
- [ ] Cambiar `sub`/`role` → admin. → [[vulnerabilities/018-jwt-attacks/examples/001-unverified-signature|001]]

## 🔗 Referencias
- carpeta `vulnerabilities/018-jwt-attacks/` · [[vulnerabilities/018-jwt-attacks/scripts/crack_jwt.py|crack_jwt.py]] · ejemplos 001–008
